...
env =
  Map.merge(env, %{
    ...
    "NSHKR_TEMPORAL_ADDRESS" =>
      System.get_env("NSHKR_TEMPORAL_ADDRESS", "127.0.0.1:7233"),
    "NSHKR_VAULT_ENDPOINT" =>
      System.get_env("NSHKR_VAULT_ENDPOINT", "http://127.0.0.1:18200"),
    "NSHKR_MINIO_ENDPOINT" =>
      System.get_env("NSHKR_MINIO_ENDPOINT", "http://127.0.0.1:19000")
  })
