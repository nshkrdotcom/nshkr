(fn ->
   ...
   env =
     Map.merge(env, %{
       ...
       "NSHKR_SYNAPSE_HOST" => System.get_env("NSHKR_SYNAPSE_HOST", "127.0.0.1"),
       "NSHKR_SYNAPSE_PORT" => System.get_env("NSHKR_SYNAPSE_PORT", "4000"),
       "NSHKR_CODEX_COMMAND" =>
